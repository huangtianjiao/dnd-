"""E2E 全链路测试 — Director→resolve→apply→persist。
...
class TestE2ECanary:
    ...
    def test_rng_context_reproducibility(self):
        ...
        rolls1 = [rng1.roll_die(20) for _ in range(10)]
        rolls2 = [rng2.roll_die(20) for _ in range(10)]

        assert rolls1 == rolls2

    def test_rng_context_different_seeds(self):
        """TEST-003: 不同种子产生不同序列。"""
    ...
    def test_roll_record_captures_info(self):
        """TEST-003: RollRecord 记录完整掷骰信息。"""
